...
# FUNCTIONS: 
# ----------------------------------------
def align_and_project_config_parser(config_file,parameters):
    ...
    """
    necessary_parameters = ['output_directory','system_descriptor','make_selections_functions_file','align_and_project_functions_file','alignment_structure_data_file','pdb','trajectory_list','eigenvector_file_naming']
    all_parameters = ['output_directory','system_descriptor','make_selections_functions_file','align_and_project_functions_file','alignment_structure_data_file','pdb','trajectory_list','eigenvector_file_naming','substrate_node_definition','substrate_selection_string','plotting_boolean','nProjections','figure_format','write_summary']
    ...
    parameters['substrate_node_definition'] = 'COM'
    parameters['substrate_selection_string'] = 'protein'
...
def align_and_project_summary(summary_filename,arguments,parameters):
